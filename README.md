...
**আগে থেকে চালু ডাটাবেজ থাকলে:** পুরো ফাইল আবার রান করার দরকার নেই — `docs/schema.sql`-এর একদম শেষের **"Security-hardening migration"** ব্লকটা কপি করে একবার রান করলেই হবে (এটা কোনো ডেটা মোছে না)। এই ব্লকটা পাবলিক বুকিং রিকোয়েস্টের সার্ভার-সাইড ভ্যালিডেশন (ফোন/নাম/তারিখ/সময়), স্প্যাম-লিমিট, আর সার্ভার-সাইড দাম হিসাব চালু করে — **এটা রান না করলে নতুন ভার্সনের পাবলিক বুকিং ফর্ম কাজ করবে না** (ফর্ম এখন আর নিজে `total_amount` পাঠায় না, ডাটাবেজই হিসাব করে)।
